...
class MagnetometerDetailScreen extends StatefulWidget {
  ...
  @override
  State<MagnetometerDetailScreen> createState() =>
      _MagnetometerDetailScreenState();
}
...
class _MagnetometerDetailScreenState extends State<MagnetometerDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Magnetometer – szczegóły'),backgroundColor: kBackgroundColor,foregroundColor: kAccentColor,),
